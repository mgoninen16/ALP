...
name = input("Please input the name of a Video Game")
if name == videoGames[0]:
  videoGames.pop(0)
elif name == videoGames[1]:
  videoGames.pop(1)
elif name == videoGames[2]:
  videoGames.pop(2)
elif name == videoGames[3]:
  videoGames.pop(3)
elif name == videoGames[4]:
  videoGames.pop(4)
else:
